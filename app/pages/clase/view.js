...
function View (props) {
    const { message } = props; // props que recibe el componente desde el server-side rendering
    const [count, setCount] = React.useState(0);

    const preloadedState = {
        message
    } // props que va a recibir el navegador del usuario para el client-side rendering
    ...
    return (
        <>
            ...
            {/* Carga el archivo app/client/clase.js en el navegador del usuario (cliente)
                NOTA: todavía NO creamos este archivo. */}
            <Script src="clase.js"/>
